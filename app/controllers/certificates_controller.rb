class CertificatesController < ApplicationController
  ...
  private
    ...
    def certificate_params
      params.require(:certificate).permit(:claimable_uri, :claimable_type, :template_pdf, :template_background_image, :certificate_type, :available_credit, :expiration_date)
    end
end
